...
const Home = () => {
  return <section>
    ...
    <article className="dev-info">
      <p>Hello! I am Santiago Vedia, the developer of this webpage</p>
      <p>You can find more information about me <Link to={ "https://www.linkedin.com/in/santivediag/" }>here</Link>. Feel free to send me a message if you want to contact me!</p>
